    ...
    <div id="content-wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="card mb-3">
                        <div class="card-header userCardHeader">Užduočių statistika</div>
                                    ...
                                    <tr>
                                        ...
                                        <td><form action="myTasksReport.php" method="post">
                                                <div class="row">
                                                    ...
                                                    <input type="submit" value="Pasirinkti" class="btn userTaskButton">
                                                </div>
                            </div>
                            </form></td>
                            </tr>
            ...
            <div class="col-lg-6 float-right">
                <div class="card mb-3">
                    <div class="card-header userCardHeader">Skritulinė diagrama</div>
