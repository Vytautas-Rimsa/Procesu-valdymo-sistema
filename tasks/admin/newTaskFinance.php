...
$data = DB::getDepartmentFinance("Finansų skyrius");
...
<div id="wrapper">
    ...
    <ul class="sidebar navbar-nav">
        ...
        <li class="nav-item">
            ...
            <div class="dropdown-menu" aria-labelledby="pagesDropdown">
                ...
                <a class="dropdown-item" href="#">Finansų skyriui</a>
    ...
    <div id="content-wrapper">
        <div class="container-fluid">
            <div class="card mb-3">
                <div class="card-header adminCardHeader">Sukurti naują užduotį finansų skyriui</div>
                <div class="card-body">
                    <div id="newTask">
