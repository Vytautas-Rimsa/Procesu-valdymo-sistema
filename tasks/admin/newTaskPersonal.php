...
$data = DB::getDepartmentPersonal("Personalo skyrius");
        ...
        <div class="collapse navbar-collapse" id="navbarColor03">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="form-inline my-2 my-lg-0">
                    <input class="form-control mr-sm-2 paieska" type="text" placeholder="Paieška">
                    <button class="btn btn-secondary mr-sm-4 paieska" type="submit">Paieška</button>
                </li>
...
<div id="wrapper">
    ...
    <ul class="sidebar navbar-nav">
        ...
        <li class="nav-item">
            ...
            <div class="dropdown-menu" aria-labelledby="pagesDropdown">
                ...
                <a class="dropdown-item" href="#">Personalo skyriui</a>
    ...
    <div id="content-wrapper">
        <div class="container-fluid">
            <div class="card mb-3">
                <div class="card-header adminCardHeader">Sukurti naują užduotį personalo skyriui</div>
                <div class="card-body">
                    <div id="newTask">
