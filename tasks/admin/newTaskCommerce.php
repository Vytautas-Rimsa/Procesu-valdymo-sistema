            ...
            <div id="wrapper">
                ...
                <div id="content-wrapper">
                    <div class="container-fluid">
                        <div class="card mb-3">
                            <div class="card-header adminCardHeader">Sukurti naują užduotį komercijos skyriui</div>
                                        ...
                                        <?php if ($data->num_rows > 0) {
                                            ...
                                            while($row = $data->fetch_assoc()){
                                                ...
                                                <tr class="container activeTasksContainer">
                                                    <td colspan="4">
                                                        <form action="newTaskCommerce.php?newtask=<?php echo $row['darb_id']?>" method="post">
                                                            <div class="row">
                                                                <div class="col col-md-8"><input class="activeTasksInput form-control" placeholder="Užduoties pavadinimas" name="title"><textarea class="activeTasksTextarea form-control" placeholder="Užduoties aprašymas" name="task"></textarea>
                                                                </div>
                                                                <div class="col col-md-1">
                                                                    <input type="submit" value="Įrašyti" class="btn adminButton">
                                                                </div>
                                                                <div class="col-md-3">
