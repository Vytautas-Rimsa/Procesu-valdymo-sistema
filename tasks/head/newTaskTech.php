        ...
        <div id="wrapper">
            ...
            <div id="content-wrapper">
                <div class="container-fluid">
                    <div class="card mb-3">
                        <div class="card-header headCardHeader">Sukurti naują užduotį technikos skyriui</div>
                        <div class="card-body">
                            <div id="newTask">
                                        ...
                                        <td colspan="4">
                                            <form action="newTaskTech.php?newtask=<?php echo $row['darb_id']?>" method="post">
                                                <div class="row">
                                                    ...
                                                    <div class="col col-md-8"><input class="activeTasksInput form-control" placeholder="Užduoties pavadinimas" name="title">
