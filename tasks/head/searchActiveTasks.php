...
$data = DB::searchTaskFromActive($_POST['search']);
...
<div id="wrapper">
    ...
    <div id="content-wrapper">
        <div class="container-fluid">
            <div class="card mb-3">
                <div class="card-header headCardHeader">Paieškos rezultatai</div>
                <div class="card-body">
                    <div id="newTask">
                                            ...
                                            <form action="" method="post">
                                                <div class="row">
                                                    ...
                                                    <div class="col col-md-2 didButtons">
                                                        <i class='fas fa-edit headCompleteTask' id="actionsAllTasks"></i>
                                                        <a onclick="redirect('<?php echo $row['task_id'];?>')"><i class='fas fa-trash-alt headCompleteTask' id="actionsAllTasks"></i></a>
                                                    </div>
                                                </div>
                                            </form>
                                        </td>
