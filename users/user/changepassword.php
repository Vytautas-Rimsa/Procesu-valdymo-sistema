            ...
            <div class="collapse navbar-collapse" id="navbarColor03">
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="nav-item mr-sm-4">
                        <a href="info.php"><i class='fas fa-address-card'id="infoLight"></i></a>
                    </li>
...
//                                        'noSpaces' => true
                    ...
                    <fieldset>
                        <div class="form-group row">
                            <label for="password_current" class="col-sm-4 col-form-label userWords">Dabartinis slaptažodis</label>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group row">
                            <label for="password_new" class="col-sm-4 col-form-label userWords">Naujas slaptažodis</label>
                            <div class="col-sm-8">
                                <input type="password" class="form-control" name="password_new" id="password_new" placeholder="Įveskite naują slaptažodį" value="">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="password_new_again" class="col-sm-4 col-form-label userWords">Pakartoti slaptažodį</label>
                            <div class="col-sm-8">
                        ...
                        <div class="my-2 my-lg-0">
                            <button type="submit" class="btn userButton my-2 my-sm-0 btnRight" name="login_btn" value="Change";">Atnaujinti slaptažodį</button>
